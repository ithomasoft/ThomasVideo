...
import com.thomas.core.NetworkUtils;
...
public class SuperVideo extends JzvdStd {
    ...
    private SuperVideoListener superVideoListener;
    //视频控制布局
    ...
    public SuperVideoListener getSuperVideoListener() {
        return superVideoListener;
    }

    public void setSuperVideoListener(SuperVideoListener superVideoListener) {
        this.superVideoListener = superVideoListener;
    }


    @Override
    public int getLayoutId() {
        return R.layout.view_super_video;
    }
...
//                    onStatePreparingChangeUrl();
            ...
            case R.id.next_set:
                dismissNextView();
                cancelDismissNextViewTimer();
                if (superVideoListener != null) {
                    superVideoListener.nextClick();
                }
                break;
            case R.id.back:
            case R.id.top_back:
                if (superVideoListener != null) {
                    superVideoListener.backClick();
                }
                break;
            case R.id.tv_speed:
                if (superVideoListener != null) {
                    superVideoListener.speedClick();
                }
                break;
            case R.id.tv_select_parts:
                if (superVideoListener != null) {
                    superVideoListener.selectPartsClick();
                }
                break;
            ...
            case R.id.screen:
                if (superVideoListener != null) {
                    superVideoListener.throwingScreenClick();
                }
                break;
        }
    }
...
//        //切换播放地址之后继续以1倍速播放
    ...
    public void updateStartImage() {
        if (state == STATE_PLAYING) {
            ...
            startButton.setImageResource(R.mipmap.player_btn_movie_suspend);
            start_bottom.setImageResource(R.mipmap.player_btn_movie_stop_bottom);
            ...
            startButton.setImageResource(R.mipmap.player_btn_movie_play);
            start_bottom.setImageResource(R.mipmap.player_btn_movie_play_bottom);
            replayTextView.setVisibility(GONE);
            fastForward.setVisibility(GONE);
            quickRetreat.setVisibility(GONE);
        }
...
//        super.onStatePlaying();
    ...
    public void changeStartButtonSize(int size) {
        //修改框架原本的图标大小
        size = (int) getResources().getDimension(R.dimen.jz_start_button_w_h_normal_player);
    ...
    public void changeNextBottonUi(boolean isNext) {
        this.isNext = isNext;
        if (isNext) {
            next_bottom.setImageResource(R.mipmap.player_btn_movie_next);
            next_bottom.setClickable(true);
        } else {
            next_bottom.setImageResource(R.mipmap.player_btn_movie_unll_next);
    ...
    public interface SuperVideoListener {
