...
import com.thomas.video.adapter.VideoEpisodeAdapter;
...
public class VideoEpisodePopup extends PopupWindow {
    ...
    private List<EpisodeData> episodeList;
    ...
    public VideoEpisodePopup(Context context, List<EpisodeData> entities) {
        super(context);
        this.mC = context;
        mC = context;
    ...
    public interface EpisodeClickListener {
         ...
         * @param position
         */
        void onEpisodeClickListener(EpisodeData entity, int position);
    }
