...
public class PlayAndPauseView extends View {
    ...
    //线的间隔
    private float mLineInterval = SizeUtils.dp2px(15);
    //线的长度
    private float mLineLength = SizeUtils.dp2px(18);
    private Paint linePaint;
    //线的粗度
    private float lineThickness = SizeUtils.dp2px(4);
    ...
    private void init() {
        ...
        linePaint.setColor(ColorUtils.getColor(android.R.color.white));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (animationStep == 2) {
            ...
            leftPath.cubicTo(leftWidth, startHeight, leftWidth + SizeUtils.dp2px(1), startHeight - SizeUtils.dp2px(2), leftWidth + SizeUtils.dp2px(4), startHeight - SizeUtils.dp2px(1));
            leftPath.lineTo(leftWidth + mLineInterval, startHeight + mLineLength / 2 - SizeUtils.dp2px(1));
            leftPath.cubicTo(leftWidth + mLineInterval, startHeight + mLineLength / 2.0F - SizeUtils.dp2px(1), leftWidth + mLineInterval + SizeUtils.dp2px(2), startHeight + mLineLength / 2 - SizeUtils.dp2px(1) + SizeUtils.dp2px(2), leftWidth + mLineInterval, startHeight + mLineLength / 2.0F - SizeUtils.dp2px(1.0F) + SizeUtils.dp2px(4.0F));
            leftPath.lineTo(leftWidth + SizeUtils.dp2px(4), startHeight + mLineLength + SizeUtils.dp2px(1));
            leftPath.cubicTo(leftWidth + SizeUtils.dp2px(4), startHeight + mLineLength + SizeUtils.dp2px(1), leftWidth + SizeUtils.dp2px(1), startHeight + mLineLength + SizeUtils.dp2px(2), leftWidth, startHeight + mLineLength);
            ...
            rightPath.arcTo(leftWidth, startHeight + mLineLength - SizeUtils.dp2px(8)
                    , leftWidth + mLineInterval, startHeight + mLineLength + SizeUtils.dp2px(8)
                    , 0, 180, false);
