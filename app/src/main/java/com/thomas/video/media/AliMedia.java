package com.thomas.video.media;
...
public class AliMedia extends JZMediaInterface implements IPlayer.OnPreparedListener, IPlayer.OnVideoSizeChangedListener, IPlayer.OnCompletionListener, IPlayer.OnErrorListener, IPlayer.OnInfoListener, IPlayer.OnSeekCompleteListener, IPlayer.OnRenderingStartListener, IPlayer.OnLoadingStatusListener {

    private static final String TAG = AliMedia.class.getSimpleName();
...
//            aliyunMediaPlayer.setLoop(true); // 是否循环播放
            ...
            //region 监听
            aliyunMediaPlayer.setOnPreparedListener(AliMedia.this); // 准备成功事件
            aliyunMediaPlayer.setOnVideoSizeChangedListener(AliMedia.this); // 视频分辨率变化回调
            aliyunMediaPlayer.setOnCompletionListener(AliMedia.this); // 播放完成事件
            aliyunMediaPlayer.setOnErrorListener(AliMedia.this); // 出错事件
            aliyunMediaPlayer.setOnInfoListener(AliMedia.this); //其他信息的事件，type包括了：循环播放开始，缓冲位置，当前播放位置，自动播放开始等
            aliyunMediaPlayer.setOnSeekCompleteListener(AliMedia.this); // 拖动事件
            aliyunMediaPlayer.setOnRenderingStartListener(AliMedia.this); // 首帧渲染显示事件
            aliyunMediaPlayer.setOnLoadingStatusListener(AliMedia.this);
            //endregion
